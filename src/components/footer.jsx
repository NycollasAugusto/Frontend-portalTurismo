...
const Footer = () => {
    return (
        <>
        <footer className="w-full bg-gradient-to-r from-orange-200 to-orange-600 text-black py-2 px-2 shadow-lg mt-auto">
            <div className="w-full mx-auto flex flex-col md:flex-row justify-between items-center">
                <div className="text-center md:text-left mb-4 md:mb-0">
                    <p className="text-sm text-black"> DRAGON BALL</p>
                </div>
